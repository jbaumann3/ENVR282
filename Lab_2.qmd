...
ggplot gives us options to change point shape using the aesthetic option 'shape' </br> We can either change shape based on a characteristic of the data ('cyl', for example), make all the shapes the same, or manually control shape
